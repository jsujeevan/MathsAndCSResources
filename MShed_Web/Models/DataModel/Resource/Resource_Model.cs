...
{
	public class Resource_Model : GenericModel
	{
		...
		[DataBinder(DataBinderName="FK_ResourceType_i")]
		...
		[DataBinder(DataBinderName="PK_Resource_ID_s", PrimaryKey = true)]
		public Guid PK_Resource_ID_s {get; set;}

		[DataBinder(DataBinderName="Resource_Archive_b")]
